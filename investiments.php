    ...
    <div class="container">
        <div class="row clearfix">
        	...
        	<div class="col-md-4 column">
				<a href="investimentsBrazil.php"><img src="img/investiment-brazil.jpg" width="100%" alt=""></a>
			</div><!-- FIM COLUNA -->
			<div class="col-md-4 column">
				<a href="finacingInvestmentFund.php"><img src="img/fanacing.png" width="100%" alt=""></a>
			</div><!-- FIM COLUNA -->
